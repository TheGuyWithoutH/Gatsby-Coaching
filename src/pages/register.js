            ...
            return (
                <div className="content">
                    ...
                    <div className="intro-txt">
                        ...
                        <p className="explanation">Avant d'accéder pour la première fois au site de ton groupe de
                            coaching, on aimerait en apprendre
                            un peu plus sur toi. Loin de nous l'idée de te voler des informations pour les vendre 😈,
                            elles nous serviront
                            pour une petite présentation de qui tu est sur le site, et aussi à organiser un peu nos
                            prochains évènements.
                            Hormis les champs obligatoires (*), tu es libre de compléter ou non.<br/>Merci d'avance 😁
                        </p>
                    </div>
                    <form className="form" action="https://www.theguywithouth.fr/coaching/db-query/user-data.php"
                        ...
                        <div className="alcohol-container">
                            ...
                            <div className="alcohol-form">
                                ...
                                <span title="Pas d'alcool">
                                    <img src="https://image.flaticon.com/icons/png/512/4330/4330187.png"
                                ...
                                <span title="Cocktail">
                                    <img src="https://image.flaticon.com/icons/png/512/920/920539.png"
                                         className="alcohol-icon"/>
                                </span>
                                </label>
                                ...
                                <label htmlFor="wine">
                                <span title="Vin">
                                    <img src="https://image.flaticon.com/icons/png/512/4425/4425723.png"
                                         className="alcohol-icon"/>
                                </span>
                                </label>
                                ...
                                <label htmlFor="beer">
                                <span title="Bière">
                                    <img src="https://image.flaticon.com/icons/png/512/2884/2884841.png"
                                         className="alcohol-icon"/>
                                </span>
                                </label>
                                ...
                                <span title="Shots de Vodka...">
                                    <img src="https://image.flaticon.com/icons/png/512/1930/1930710.png"
                                         className="alcohol-icon"/>
                                </span>
                                </label>
                                ...
                                <span title="Whiskey, spiritueux ...">
                                    <img src="https://image.flaticon.com/icons/png/512/920/920521.png"
                                         className="alcohol-icon"/>
                                </span>
                                </label>
                            </div>
